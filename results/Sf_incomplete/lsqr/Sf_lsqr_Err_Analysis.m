...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 1:nlevels
    pf_string.title     = sprintf(['LSQR resolved ODF from incomplete PF \n corrupted with poisson noise a = ', num2str(alpha(i)), ' & b = ', num2str(bkg)]);
...
print -depsc2 odf_err_lsqr_sf_incomplete.eps
close;
...
print -depsc2 pf_snr_lsqr_sf_incomplete.eps
close;
...
print -depsc2 pf_psnr_lsqr_sf_incomplete.eps
close;
