...
print -depsc2 pf_psnr_l1_sf_complete.eps
close;
...
grid on;
set(gca,'GridLineStyle','--');
print -depsc2 pf_snr_l1_sf_complete.eps
close;
...
for i = 1:nlevels
    ...
    pf_string.title     = sprintf(['L1 resolved ODF, initially, corrupted with poisson noise a = ', num2str(alpha(i)), ' & b = ', num2str(bkg)]);
