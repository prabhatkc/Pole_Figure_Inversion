...
%  Upload datasets 
%%%%%%%%%%%%%%%%%%%%%%
BigA  = load('BigA-SF-ncub10-unnormalized-Incomplete.txt'); % upload forward projection matrix
...
if (isOctave ==0)
    save ('../../dataset/matlab/SantaFe_input_noise_pf_incomplete.mat', 'all_pf', 'alpha', 'bkg');
else
    save ('../../dataset/octave/SantaFe_input_noise_pf_incomplete.mat', 'all_pf','alpha', 'bkg' );
end
