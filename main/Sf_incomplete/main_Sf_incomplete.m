...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
BigA  = load('BigA-SF-ncub10-unnormalized-Incomplete.txt');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('SantaFe_input_noise_pf_incomplete.mat');
...
dataset.b_sim       = b_sim;
dataset.gt          = gt;
dataset.prompt_disp	= 'F'; %T to display; F to hide (for TV options)
...
admm_opts.para_est            = 'T';
invert_3_pf_incomplete(dataset, admm_opts);
